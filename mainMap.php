...
<html lang="en">
      ...
      <div class="header clearfix">
        <nav>
          <ul class="nav nav-pills float-right">
            <li class="nav-item">
              <a class="nav-link active" href="mainMap.php">Home</a>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="signNewUser.php">Signup User</a>
              </li>
          </ul>
        </nav>
 ...
 <marquee behavior="scroll" direction="left" bgcolor="white" onmouseover="this.stop()" onmouseout="this.start()" scrollamount="8" scrolldelay="100"> Latest News --> 
        ...
        <?php  
                      ...
                      while($res=mysqli_fetch_array($data)){
                       ...
                       echo ' <a href="readMoreNews.php? id='.$res[0].'">';
                                 echo''.$res[3].'';    
  ...
  var customLabel = {
        ...
        var infoWindow = new google.maps.InfoWindow;
          ...
          downloadUrl('mainMapDb.php', function(data) {

...
<div class="card mb-3">
        ...
        <div class="card-header">
          <i class="fa fa-table"></i> Emergency Map</div>
        <div class="card-body">
          <div class="table-responsive">
              ...
              <form>
                  <input type="button" value="Click to go to Add to Map Page" onclick="window.location.href='http://localhost/web/admin-map.php'" style="height: 100px;,width: 100px;," />
              </form>

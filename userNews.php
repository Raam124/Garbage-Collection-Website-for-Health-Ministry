  ...
  <div class="content-wrapper">
   ...
   <div class="card mb-3">
        ...
        <div class="card-header">
          <i class="fa fa-table"></i> Add News</div>
        <div class="card-body">
          <div class="table-responsive">



                    <form id="contact-form" method="post" action="addNewsToDb.php" role="form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                     ...
                                     <input id="form_lastname" type="text" name="username" class="form-control" placeholder="Please enter your username *">
                                     <br><label for="form_email">Title *</label>
                                     <input id="form_lastname" type="text" name="title" class="form-control" placeholder="Please enter Title *">
                                     <br><label for="form_email">Upload your image *</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <label for="form_message">Post Body *</label>
                                        <textarea id="form_message" name="post" class="form-control" placeholder="Post body *" rows="4" ></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <input type="submit" class="btn btn-success btn-send" value="Add News">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">

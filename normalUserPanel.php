      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="normalUserPanel.php">
            ...
            <span class="nav-link-text">Add to Admin List</span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
   ...
   <div class="card mb-3">
        ...
        <div class="card-header">
          <i class="fa fa-table"></i> The information you add on this page will go to Admin's List if you wanna show that in Admin's map too there is an another page below as Add to Map</div>
        <div class="card-body">
